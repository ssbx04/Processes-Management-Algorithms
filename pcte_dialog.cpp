...
#include "pcte.h"
pcte_dialog::pcte_dialog(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::pcte_dialog)
{
    ui->setupUi(this);
    ...
    modele1->setItem(0, 0, new QStandardItem("PCTE"));
...
pcte_dialog::~pcte_dialog()
{
    delete ui;
}

void pcte_dialog::dessiner(){
    int nbrproc = l.listProcessSize();
...
void pcte_dialog::showEvent(QShowEvent *event) {
