...
fifo_dialog::fifo_dialog(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::fifo_dialog)
{
    ui->setupUi(this);
    ...
    modele1->setItem(0, 0, new QStandardItem("FIFO"));
    ...
    modele->setItem(nbrproc*4+nbrproc+1, 0, new QStandardItem("E/S"));
...
fifo_dialog::~fifo_dialog()
{
    delete ui;
}

void fifo_dialog::dessiner(){
    int nbrproc = l.listProcessSize();
...
void fifo_dialog::showEvent(QShowEvent *event) {
