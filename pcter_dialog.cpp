...
pcter_dialog::pcter_dialog(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::pcter_dialog)
{
    ui->setupUi(this);
    ...
    modele1->setItem(0, 0, new QStandardItem("PCTER"));
...
pcter_dialog::~pcter_dialog()
{
    delete ui;
}

void pcter_dialog::dessiner(){
...
void pcter_dialog::showEvent(QShowEvent *event) {
