...
#include "ui_tourniquet_dialog.h"
#include "QTableView"
#include "QVBoxLayout"
...
tourniquet_dialog::tourniquet_dialog(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::tourniquet_dialog)
{
    ui->setupUi(this);
    ...
    modele1->setItem(0, 0, new QStandardItem("TOURNIQUET"));
...
tourniquet_dialog::~tourniquet_dialog()
{
    delete ui;
}

void tourniquet_dialog::dessiner(){
    int nbrproc = l.listProcessSize();
...
void tourniquet_dialog::showEvent(QShowEvent *event) {
